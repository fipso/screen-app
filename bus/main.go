...
func main() {
	...
	for {
		...
		GetBusTime("-> Night City", "de%3A05158%3A19001", "de%3A05158%3A13980")
		fmt.Println()
		GetBusTime("-> Die Rosi", "de%3A05158%3A19001", "de%3A05158%3A18969")
		time.Sleep(time.Second * 30)
	}

}

func GetBusTime(label, origin, destination string) {
	...
	for _, journey := range busData.Journeys {
		...
		fmt.Println("   ", conn.Origin.DepartureTimeEstimated.In(loc).Format("15:04"))
		// Reset ansi color
		fmt.Print("\033[0m")
		if n == 2 {
			break
